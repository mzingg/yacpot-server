...
public class MongoDbPersistence implements Persistence {
  ...
  public MongoDbPersistence(MongoDbApplication application) {
    this.database = application.getMongoClient().getDB(application.getDatabaseName());
  }
  ...
  @Override
  public GenericModel<?> resolveById(ModelIdentifier id) throws PersistenceException {
  ...
  public <T> T resolveById(ModelIdentifier id, Class<T> desiredObjectType) throws PersistenceException {
  ...
  protected void fillModel(Object model, DBObject mongoObj) throws PersistenceException {
  ...
  protected Object mapAndPersistValue(Object value) throws PersistenceException {
    ...
    } else if (value instanceof ModelIdentifier) {
  ...
  protected Object reverseMapValue(Object mongoValue, Class<?> targetType) throws PersistenceException {
    ...
    } else if ((targetType == null || ModelIdentifier.class.isAssignableFrom(targetType)) && mongoValue instanceof ObjectId) {
      return new ModelIdentifier(mongoValue.toString());
    }
